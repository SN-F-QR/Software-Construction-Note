 ...
 * @param {(new) => void} update update new story when submitted
 */
const NewStory = (prop) => {
  const addStory = (value) => {
    const body = { content: value };
    post("/api/story", body).then(() => {
      prop.update({ creator_name: "Anonymous User", content: value });
    });
  };
